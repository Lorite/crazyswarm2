...
def main():
    ...
    waypoints_file = data_dir / 'small_rectangle_absolute_waypoints.csv'
    output_file = data_dir / 'small_rectangle_absolute.csv'

    data = np.loadtxt(waypoints_file, delimiter=',', skiprows=1)
    traj = generate_trajectory(data, num_pieces=17)
